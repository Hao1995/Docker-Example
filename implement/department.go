...
//InsertDepartment ... Store Data
func InsertDepartment(res http.ResponseWriter, req *http.Request) {

	filename := "C:/Users/user/Downloads/104Hackathon/category/department.csv"
	...
	for _, line := range lines {
		...
		queryString := "INSERT INTO `department`(`id`,`name`,`desc`,`hide`) VALUES"
		value :=
			"(" +
